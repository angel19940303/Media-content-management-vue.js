...
import { NewsEntryDataPayload } from "../../../models/news/news-entry-data-payload";
...
class NewsEntryList extends React.Component<RProps, RState> {
                ...
                <Grid container alignItems="center" justify="flex-end">
                  ...
                  <Grid item>
                    <IconButton
                      onClick={() => this.onPaginationClick(1)}
                      disabled={
                        this.state.content.data.data.length === 0 || isLastPage
                      }
                    >
                      <ChevronRight />
                    </IconButton>
  ...
  private renderRows(): React.ReactNode {
    ...
    return data.data.map((item, index) => (
      <TableRow key={item.ID}>
        ...
        <TableCell padding="none" className={this.props.classes.newsEntryCell}>
          {this.state.content.enums.providerName(item.Provider)}
        </TableCell>
        <TableCell padding="none" className={this.props.classes.newsEntryCell}>
          {item.Title}
        </TableCell>
  ...
  private updateItemAtIndex(
    ...
    const newData = {
      data: Array.from(this.state.content.data.data),
      totalNumberOfRecords: this.state.content.data.totalNumberOfRecords,
    };
